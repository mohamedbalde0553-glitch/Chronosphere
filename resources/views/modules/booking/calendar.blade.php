<x-app-layout>
    ...
    <style>
        ...
        .dark .fc-day-today { background: #3a1f0e !important; }
    ...
    <div x-data="bookingApp()" class="space-y-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 px-4 py-3 flex flex-wrap items-center gap-3">
            <div class="flex items-center gap-2 text-sm">
                ...
                <select x-model="filterType" @change="applyFilter()"
                        class="px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-lg text-sm bg-white dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-orange-400">
        ...
        {{-- Conflict alert --}}
        <div x-show="conflicts.length > 0" x-cloak class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-4">
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-md z-10" @click.stop>
                ...
                <div class="px-6 py-5 space-y-4">
                    <div>
                        ...
                        <input type="text" x-model="form.title" placeholder="Réunion d'équipe…"
                               class="w-full px-3 py-2.5 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
                               :class="errors.title ? 'border-red-400' : ''">
                        <p x-show="errors.title" x-text="errors.title" class="mt-1 text-xs text-red-600"></p>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Ressource <span class="text-red-500">*</span></label>
                        <select x-model="form.resource_id"
                                class="w-full px-3 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg text-sm bg-white dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-orange-500"
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nombre de participants</label>
                    ...
                    <div>
                        ...
                        <textarea x-model="form.description" rows="2" placeholder="Optionnel…"
                                  class="w-full px-3 py-2.5 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 resize-none"></textarea>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between px-6 py-4 border-t border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                    <button x-show="editMode" @click="cancelBooking()"
                            class="text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 px-3 py-2 rounded-lg">Annuler la résa.</button>
                    <div class="flex gap-3 ml-auto">
                        <button @click="closeModal()" class="px-4 py-2 text-sm text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600">Fermer</button>
